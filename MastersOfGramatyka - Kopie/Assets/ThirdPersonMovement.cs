...
public class ThirdPersonMovement : MonoBehaviour
{
    ...
    public bool crouching; //damit wir unseren spieler mit dem bool sprinting flaggen können, betrifft auch crouching und sneaking.
    public bool zoomed;
